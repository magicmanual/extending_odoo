...
from odoo.tools import float_round, float_compare, UserError
                        ...
                        if picking_type_id.use_create_lots:
                            ...
                            if ml.lot_name and not ml.lot_id:
                                lot = self.env['stock.production.lot'].create(
                                    {'name': ml.lot_name, 'product_id': ml.product_id.id, 'company_id': ml.move_id.company_id.id,'expire_date' : ml.expire_date}
                                )
